...
public class VentanaInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(bLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 640, 80, 50));
        ...
        getContentPane().add(lPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 550, -1, -1));
        ...
        lID.setText("Username:");
        getContentPane().add(lID, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 500, -1, -1));
    ...
    private void bLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bLoginActionPerformed
        ...
        if(!txtID.getText().equals("") && !txtPass.getText().equals("")){
            if(txtID.getText().equals(uadmin) && txtPass.getText().equals(padmin)){
               ...
               lanuncio.setText("Invalid credentials!");
                this.repaint(); 
            }
           
        }else {
            lanuncio.setText("There are empty fields!");
            this.repaint();
        }
