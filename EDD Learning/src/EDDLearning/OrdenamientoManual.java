...
public class OrdenamientoManual extends javax.swing.JFrame {
    ...
    public OrdenamientoManual(Usuario usuarioaux, JSONObject ObjOrdenamiento, String tipo_ordenamiento) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(bnext, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 470, 90, 90));
        ...
        getContentPane().add(lnext, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 570, -1, -1));
        ...
        getContentPane().add(txtExplicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 480, 330, 60));
        ...
        getContentPane().add(lexplicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 450, -1, -1));
        ...
        getContentPane().add(bplay, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 470, 90, 90));
        ...
        getContentPane().add(liniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 570, -1, -1));

        lgoback.setForeground(new java.awt.Color(255, 255, 255));
        lgoback.setText("REGRESAR");
        getContentPane().add(lgoback, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 610, 70, 30));
        ...
        getContentPane().add(bsalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 560, 50, 50));
        ...
        getContentPane().add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 700, 650));
