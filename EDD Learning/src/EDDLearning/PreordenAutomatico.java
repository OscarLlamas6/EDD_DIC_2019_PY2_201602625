...
public class PreordenAutomatico extends javax.swing.JFrame {
    ...
    public PreordenAutomatico(Usuario usuarioaux, ListaSimple numeros) {
    ...
    private void initComponents() {
        ...
        bplay.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/siguiente1.png"))); // NOI18N
        bplay.setBorder(null);
        bplay.setBorderPainted(false);
        bplay.setContentAreaFilled(false);
        bplay.setFocusPainted(false);
        bplay.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/siguiente2.png"))); // NOI18N
        ...
        ltitutlo.setText("ÁRBOL AVL: RECORRIDO PREORDEN");
       ...
       if (file.exists()){ file.delete();}
        try {
            ...
            try {
                ...
                Logger.getLogger(PreordenAutomatico.class.getName()).log(Level.SEVERE, null, ex);
            }
