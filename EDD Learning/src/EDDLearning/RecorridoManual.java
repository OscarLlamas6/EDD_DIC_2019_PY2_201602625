...
public class RecorridoManual extends javax.swing.JFrame {
    ...
    public RecorridoManual(Usuario usuarioaux, ListaSimple numeros, String recorrido) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lnext, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 240, -1, -1));
        ...
        getContentPane().add(bnext, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 140, 90, 90));
        ...
        getContentPane().add(bplay, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 140, 90, 90));
        ...
        getContentPane().add(liniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 240, -1, -1));
       ...
       if (file.exists()){ file.delete();}
        try {
            ...
            try {
                ...
                Logger.getLogger(RecorridoManual.class.getName()).log(Level.SEVERE, null, ex);
            }
